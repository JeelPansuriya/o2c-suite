...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheProductsList.onFilterBar().iCheckFilterField("productID");
            ...
            Then.onTheProductsList.onFilterBar().iCheckFilterField("status");
        });

        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheProductsList.onTable().iCheckColumns(6, {"productID":{"header":"Product ID"},"productName":{"header":"Product Name"},"category":{"header":"Category"},"price":{"header":"Price"},"stock":{"header":"Stock"},"status":{"header":"Status"}});
