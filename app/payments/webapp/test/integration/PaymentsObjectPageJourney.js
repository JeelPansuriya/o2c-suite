...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PaymentsObjectPageObjectPage journey");

        opaTest("Navigate to PaymentsObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
        ...
        opaTest("Check body sections of the Object Page", function (Given, When, Then) {
            Then.onThePaymentsObjectPage.iCheckSection({ section: "PaymentGeneral" });
       });
