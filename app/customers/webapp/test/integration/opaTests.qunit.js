...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "o2c/customers/test/integration/FirstJourney",
    "o2c/customers/test/integration/CustomersListJourney",
    "o2c/customers/test/integration/CustomersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
