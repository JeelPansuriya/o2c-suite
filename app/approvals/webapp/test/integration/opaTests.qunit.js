...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "o2c/approvals/test/integration/FirstJourney",
    "o2c/approvals/test/integration/ApprovalsListJourney",
    "o2c/approvals/test/integration/ApprovalsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
