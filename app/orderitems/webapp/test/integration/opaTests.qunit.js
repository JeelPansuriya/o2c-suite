...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "o2c/orderitems/test/integration/FirstJourney",
    "o2c/orderitems/test/integration/OrderItemsListJourney",
    "o2c/orderitems/test/integration/OrderItemsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
