...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheOrdersList.onFilterBar().iCheckFilterField("Order ID");
            Then.onTheOrdersList.onFilterBar().iCheckFilterField("Customer");
            Then.onTheOrdersList.onFilterBar().iCheckFilterField("Credit Status");
            Then.onTheOrdersList.onFilterBar().iCheckFilterField("Order Status");
        });
