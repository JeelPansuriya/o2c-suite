...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "o2c/analytics/test/integration/FirstJourney",
    "o2c/analytics/test/integration/OrdersListJourney",
    "o2c/analytics/test/integration/OrdersObjectPageJourney",
    "o2c/analytics/test/integration/OrderItemsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
